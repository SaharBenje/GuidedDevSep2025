namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrProcess_15b907cUsrSterne8MethodsWrapper

	/// <exclude/>
	public class UsrProcess_15b907cUsrSterne8MethodsWrapper : ProcessModel
	{

		public UsrProcess_15b907cUsrSterne8MethodsWrapper(Process process)
			: base(process) {
