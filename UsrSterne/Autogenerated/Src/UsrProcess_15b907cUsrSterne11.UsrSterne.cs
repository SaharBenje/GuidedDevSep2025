namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrProcess_15b907cUsrSterne11MethodsWrapper

	/// <exclude/>
	public class UsrProcess_15b907cUsrSterne11MethodsWrapper : ProcessModel
	{

		public UsrProcess_15b907cUsrSterne11MethodsWrapper(Process process)
			: base(process) {
