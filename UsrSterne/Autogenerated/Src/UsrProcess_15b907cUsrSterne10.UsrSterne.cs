namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrProcess_15b907cUsrSterne10MethodsWrapper

	/// <exclude/>
	public class UsrProcess_15b907cUsrSterne10MethodsWrapper : ProcessModel
	{

		public UsrProcess_15b907cUsrSterne10MethodsWrapper(Process process)
			: base(process) {
