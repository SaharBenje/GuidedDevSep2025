namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrProcess_15b907cUsrSterne6MethodsWrapper

	/// <exclude/>
	public class UsrProcess_15b907cUsrSterne6MethodsWrapper : ProcessModel
	{

		public UsrProcess_15b907cUsrSterne6MethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask3Execute(ProcessExecutingContext context) {
			...
			adresseSocieteEntity.SetColumnValue("UsrName", uniteLegale.DenominationUniteLegale ?? uniteLegale.NomUniteLegale);
