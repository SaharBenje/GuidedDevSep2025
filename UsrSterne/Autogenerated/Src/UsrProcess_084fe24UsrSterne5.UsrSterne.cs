namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrProcess_084fe24UsrSterne5MethodsWrapper

	/// <exclude/>
	public class UsrProcess_084fe24UsrSterne5MethodsWrapper : ProcessModel
	{

		public UsrProcess_084fe24UsrSterne5MethodsWrapper(Process process)
			: base(process) {
