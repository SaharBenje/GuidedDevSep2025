namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrProcess_084fe24UsrSterne3_6eccc39MethodsWrapper

	/// <exclude/>
	public class UsrProcess_084fe24UsrSterne3_6eccc39MethodsWrapper : ProcessModel
	{

		public UsrProcess_084fe24UsrSterne3_6eccc39MethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			...
			*/
			...
			sb.AppendFormat("\"currency\": \"{0}\",", relation.GetTypedColumnValue<string>("UsrDeviseName"));
