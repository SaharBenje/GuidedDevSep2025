namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrProcess_084fe24UsrSterne3MethodsWrapper

	/// <exclude/>
	public class UsrProcess_084fe24UsrSterne3MethodsWrapper : ProcessModel
	{

		public UsrProcess_084fe24UsrSterne3MethodsWrapper(Process process)
			: base(process) {
