namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrProcess_084fe24UsrSterne2MethodsWrapper

	/// <exclude/>
	public class UsrProcess_084fe24UsrSterne2MethodsWrapper : ProcessModel
	{

		public UsrProcess_084fe24UsrSterne2MethodsWrapper(Process process)
			: base(process) {
