namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrProcess_81898acUsrSterne1MethodsWrapper

	/// <exclude/>
	public class UsrProcess_81898acUsrSterne1MethodsWrapper : ProcessModel
	{

		public UsrProcess_81898acUsrSterne1MethodsWrapper(Process process)
			: base(process) {
