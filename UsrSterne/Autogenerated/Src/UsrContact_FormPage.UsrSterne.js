define("UsrContact_FormPage", /**SCHEMA_DEPS*/[]/**SCHEMA_DEPS*/, function/**SCHEMA_ARGS*/()/**SCHEMA_ARGS*/ {
	return {
		viewConfigDiff: /**SCHEMA_VIEW_CONFIG_DIFF*/[
			...
			{
				"operation": "insert",
				"name": "ComboBox_ei7r3py",
				"values": {
					"type": "crt.ComboBox",
					"label": "$Resources.Strings.PDS_UsrContratCadre_44tn9se",
					"labelPosition": "auto",
					"control": "$PDS_UsrContratCadre_44tn9se",
					"listActions": [],
					"showValueAsLink": true,
					"controlActions": [],
					"visible": true,
			...
			{
				"operation": "insert",
				"name": "addRecord_h6la7g0",
				"values": {
					"code": "addRecord",
					"type": "crt.ComboboxSearchTextAction",
					"icon": "combobox-add-new",
					"caption": "#ResourceString(addRecord_h6la7g0_caption)#",
					"clicked": {
						"request": "crt.CreateRecordFromLookupRequest",
						"params": {}
					}
				},
				"parentName": "ComboBox_ei7r3py",
				"propertyName": "listActions",
				"index": 0
			},
			{
			...
			},
			{
				...
				"values": {
					...
					"columns": [
						{
							"id": "a5da7f3d-c61c-ceed-e788-592b5a5be140",
							"code": "AddressListDS_UsrName",
							"caption": "#ResourceString(AddressListDS_UsrName)#",
							"dataValueType": 28
						}
					],
					"features": {
		...
		viewModelConfigDiff: /**SCHEMA_VIEW_MODEL_CONFIG_DIFF*/[
			{
				...
				"values": {
					...
					"AddressList": {
						...
						"viewModelConfig": {
							"attributes": {
								"AddressListDS_UsrName": {
									"modelConfig": {
										"path": "AddressListDS.UsrName"
									}
								},
								"AddressListDS_Id": {
									"modelConfig": {
					...
					"PDS_UsrContratCadre_44tn9se": {
						"modelConfig": {
							"path": "PDS.UsrContratCadre"
						}
					},
					"AddressList_PredefinedFilter": {
						"value": null
					}
				}
			},
